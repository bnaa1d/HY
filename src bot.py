...
async def sms(ctx, phone, amount:int):
    ...
    if (amount < 151):
      ...
      embes = discord.Embed(title="Mo><", description="bot noob",color=0xff4612)
      embes.add_field(name="attack",value=phone)
      ima = "https://images-ext-1.discordapp.net/external/m4dnzUGOwYrP-y7K2kk4Q9l1hVBXklXAqeiNfs_jKZw/https/media.discordapp.net/attachments/954723568426569800/955729155436187648/standard.gif"
